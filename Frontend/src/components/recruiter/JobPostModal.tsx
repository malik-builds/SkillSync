                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={e => {
                                            ...
                                            setFormData({ ...formData, salaryMin: val, salaryMax: Math.max(val, formData.salaryMax) });
                                        }}
                                        className="w-full pl-9 pr-10 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                                    />
                                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs pointer-events-none">k/mo</span>
                                </div>
                            </div>
                            <span className="text-gray-400 mt-5 text-lg">—</span>
                            <div className="flex-1 space-y-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={e => {
                                            const val = Math.max(0, parseInt(e.target.value) || 0);
                                            setFormData({ ...formData, salaryMax: val, salaryMin: Math.min(val, formData.salaryMin) });
                                        }}
                                        className="w-full pl-9 pr-10 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                                    />
                                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs pointer-events-none">k/mo</span>
